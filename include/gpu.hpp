...
namespace pxly {
    ...
    struct PixelMode_384x216x4_Indexed {
        ...
        void Textri(Machine * machine, int dx0, int dy0, int dx1, int dy1, int dx2, int dy2, int sx0, int sy0, int sx1, int sy1, int sx2, int sy2);
        ...
        /// \param sy2 Source Y-Coordiate 3 in global texture coordinates
        /// \param key The color index that should be considered transparent
        void Textri(Machine * machine, int dx0, int dy0, int dx1, int dy1, int dx2, int dy2, int sx0, int sy0, int sx1, int sy1, int sx2, int sy2, int key);
    };
    ...
    struct Textures_4bpp_Indexed {
        ...
        uint8 GetGlobalPixel(int start, int x, int y) const;
    };
